...
[
	...
	["TERRITORY_TANOA_AIRPORT_NORTH", "Tanoa Airport (North)", 5000, "AIRFIELD"],
	["TERRITORY_TANOA_AIRPORT_SOUTH", "Tanoa Airport (South)", 5000, "AIRFIELD"],
	["TERRITORY_TANOA_AIRPORT_TERMINAL", "Tanoa Airport Terminal", 5000, "AIRFIELD"],
