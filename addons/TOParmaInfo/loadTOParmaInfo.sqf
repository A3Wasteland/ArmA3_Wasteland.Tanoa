...
_serverInfoString = format ["<t align='right'><t color='#FFFFFF'>GFS Wasteland #%1 %2</t></t>", call A3W_extDB_ServerID, worldName];
...
_generalInfoString = "Website: <t color='#0091CD'><a href='http://www.gfsgaming.com'>GFS Gaming.</a></t> TeamSpeak: ts.gfsgaming.com";
...
_commandsOnline = "" ;
_commandsOffline = "addons\TOParmaInfo\commands.html";
...
_ctrlHTML = _display displayCtrl TOParmaInfo_Content_Commands;
_ctrlHTML htmlLoad _commandsOnline;
_htmlLoaded = ctrlHTMLLoaded _ctrlHTML;
if (!_htmlLoaded) then 
{
	_ctrlHTML htmlLoad _commandsOffline;
};
