/*
	...
	@File Custom Edits By: Santa @ GFSGaming
*/
...
[] spawn
{
	...
	while {true} do
	{
		...
		else
		{
			...
			_time = (round(180-(serverTime)/60));  //edit the '180' value (60*4=180) to change the countdown timer if your server restarts are shorter or longer than 4 hour intervals
