...
//	diag_log format ["AAA - Just Used Time: %1; CoolDown Set At: %2; Current Time: %3",APOC_AA_lastUsedTime, APOC_AA_coolDownTime, diag_tickTime];
	...
	sleep 1;
//	hint format ["Airdrop Inbound %2 Heading: %1 ETA: 40s",ceil _heliDirection,_selectionName];
	player groupChat format ["Airdrop Inbound %2 Heading: %1 ETA: 40 seconds",ceil _heliDirection,_selectionName];
	sleep 20;
//	hint format ["Airdrop Inbound %2 Heading: %1 ETA: 20s",ceil _heliDirection,_selectionName];
