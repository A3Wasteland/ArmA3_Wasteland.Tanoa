...
_successExec =
{
    ...
    _weaponcrates = [
      ["mission_USSpecial","US Special Weapons"],
      ["mission_Main_A3snipers", "Hunting Rifles"],
      ["mission_DLCSnipers", "Tanoa hunting rifles"],
      ["mission_DLCLMGs","Tanoa LMG's"],
      ["mission_DLCRifles", "Tanoa Rifles"]
    ];
    _crate1 = _weaponcrates call BIS_fnc_selectRandom;
    _crate2 = _weaponcrates call BIS_fnc_selectRandom;
    _box1 = createVehicle ["Box_NATO_Wps_F", (getPosATL _veh) vectorAdd ([[_veh call fn_vehSafeDistance, 0, 0], random 360] call BIS_fnc_rotateVector2D), [], 5, "None"];
		...
		[_box1, _create1 select 0] call fn_refillbox;
		...
		[_box2, _create2 select 0] call fn_refillbox;
	};

	_successHintMessage = format ["The hostile VTOL was taken out! The weapon crates have fallen out and are up for grabs!. It appears they were carrying %1 and %2 !", _crate1 select 1, _crate2 select 1];
};
