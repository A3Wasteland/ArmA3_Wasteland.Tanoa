...
_setupObjects =
{
	...
	{
		["B_Plane_CAS_01_F", "O_Plane_CAS_02_F"] call BIS_fnc_selectRandom;
	}
	else
	{
		["I_Plane_Fighter_03_CAS_F", "I_Plane_Fighter_03_AA_F", "O_Plane_CAS_02_F"] call BIS_fnc_selectRandom;
	};
...
_successExec =
{
	...
	_vehicle spawn
	{
		...
		[_box2, "mission_DLCRifles"] call fn_refillbox;
	};
