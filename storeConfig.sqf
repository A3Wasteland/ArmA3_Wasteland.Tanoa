...
[
  ...
  ["Light Combat Helmet (Tropic)", "h_helmetb_light_tna_f", 500, "hat"],
	...
	["Special Combat Helmet", "H_HelmetO_ViperSP_hex_F", 5000, "hat", "HIDDEN"],
	["Special Purpose Helmet (Green Hex)", "h_helmeto_vipersp_ghex_f", 5000, "hat", "HIDDEN"],
...
[
	...
	["Compact NVG (Hex)", "O_NVGoggles_hex_F", 5000, "nvg"],
...
[
	...
	["MQ-12 Falcon UAV", "B_T_UAV_03_F", 250000, "vehicle"] // OP AS F NO MATTER THE PRICE*/
...
[
	...
	["KH-3A Fenghuang UAV", "O_T_UAV_04_CAS_F", 40000, "vehicle", "HIDDEN"] // OP
];
